...
export class AmbienceAudio extends AudioSource {
    ...
    constructor(manager: AudioManager) {
        super(manager);
        // Background music intentionally disabled in the Bingran build.
        // The original template plays an office-ambience loop + startup sting
        // on load; both are skipped so the room is silent by default. The
        // UI click / keyboard SFX in ComputerAudio are kept for feedback.
    }
