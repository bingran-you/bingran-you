# USER.md — About Bingran

_The one you serve. Keep this living and current._
...
- Half-done work handed back as if complete.
- Verbose status updates that bury the point.
- Agents that re-ask questions they could have answered by reading a file.
...
_Respect the difference between knowing the person and building a dossier. Learn what helps you serve; ignore the rest._
